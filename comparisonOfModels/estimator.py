...
Original file is located at
    https://colab.research.google.com/drive/1dOOOMeBLAqdD1m8AkYjd3txAkn_MeL9M
"""
...
class TfPoseEstimator:
    ...
    @staticmethod
    def draw_humans(name, npimg, humans, imgcopy=False):
        xs = [-1 for _ in range(18)]
        ys = [-1 for _ in range(18)]
        ...
        for human in humans:
            ...
            for i in range(common.CocoPart.Background.value):
                ...
                xs[i] = int(body_part.x * image_w + 0.5)
                ys[i] = int(body_part.y * image_h + 0.5)
            # draw line
            ...
            import csv   
            fields=[name.partition('_2_')[2],xs,ys]
            with open(r'/content/drive/MyDrive/DL_Data/PG2_GAN/GFLA/doc.csv', 'a') as f:
                writer = csv.writer(f)
